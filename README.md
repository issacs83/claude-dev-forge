...
> Claude Code를 위한 범용 개발 프레임워크 — 21개 에이전트, 24개 커맨드, 9개 훅, 8개 규칙, 5개 MCP 서버
...
| **스킬** | 8 | 멀티스텝 워크플로우 자동화 |
| **훅** | 9 | 보안 6-layer + 품질 + 세션 관리 |
| **규칙** | 8 | 코딩 원칙, 보안, 테스트, Git |
...
│ skills/ (8개)           │            │ memory/ (프로젝트 지식) │
│ hooks/ (9개)            │            │ prompts/ (시스템 프롬프트)│
│ rules/ (8개)            │            └──────────────────────┘
